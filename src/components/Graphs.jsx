	...
	return (
		<div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: 24 }}>
			...
			<div style={{ padding: 12, border: '1px solid #eee', borderRadius: 8 }}>
				<h3>Overall Gross</h3>
				<p style={{ fontSize: 24, margin: 0 }}>${Number(stats.overallTotal).toLocaleString()}</p>
			</div>
		</div>
	)
}
